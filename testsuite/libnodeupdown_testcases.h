/*
 * $Id: libnodeupdown_testcases.h,v 1.11 2003-03-18 18:24:49 achu Exp $
...
struct {
  ...
  {IS_NOT_NULL_LOADED,    GOOD_FILENAME, GOOD_HOSTNAME, GOOD_IP, GOOD_PORT,  0, NODEUPDOWN_ERR_ISLOADED},
